...
def build_dynamic_field_schema(hass: HomeAssistant, profile: PowerProfile, source_entity: SourceEntity) -> vol.Schema:
    schema = {}
    for field in profile.custom_fields:
        ...
        if "entity" in field.selector and source_entity.device_entry:
