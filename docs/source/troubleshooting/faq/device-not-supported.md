...
To run this script you'll need the bulb itself, a smart plug , some technical affinity and some time. See [measure](../../contributing/measure/index.md) for some documentation how to do this.
