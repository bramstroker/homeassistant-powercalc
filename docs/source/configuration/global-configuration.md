...
| power_update_interval         | numeric    | **Optional** | 1                      | Throttle state changes of power sensor to only once every x seconds. 0 is disabled. See [update-frequency](update-frequency.md)                                                                                                      |
