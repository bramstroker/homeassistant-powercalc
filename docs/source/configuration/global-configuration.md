...
| energy_update_interval        | numeric    | **Optional** | 10                     | Enable time based updating of energy sensor once every x seconds. 0 is disabled. See [update-frequency](update-frequency.md)                                                                                                         |
