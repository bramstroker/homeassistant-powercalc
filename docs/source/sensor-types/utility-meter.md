...
You can change this behaviour with the `utility_meter_types` configuration option globally or per sensor or group (this will override global settings for this particular sensor or group).
