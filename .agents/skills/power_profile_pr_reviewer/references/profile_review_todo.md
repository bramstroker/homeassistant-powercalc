...
- [ ] Identify whether `lidl/399629_2110` measured physical model `HG09368` or `HG09369`; the shared manual gives 38W for both, but the exact variant is required before assigning an EAN or lumen value.
