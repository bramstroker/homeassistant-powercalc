...
from custom_components.powercalc import CONF_DISCOVERY_EXCLUDE_SELF_USAGE_DEPRECATED, CONF_GROUP_UPDATE_INTERVAL_DEPRECATED, DOMAIN
from custom_components.powercalc.const import CONF_GROUP_ENERGY_UPDATE_INTERVAL
